include .env
export
export PG_URL = "postgres://${POSTGRES_USER}:${POSTGRES_PASSWORD}@localhost:${POSTGRES_PORT}/${POSTGRES_DB}?sslmode=disable"
...
allure: ### run allure on 9999 port
	allure serve ./integration-test/allure-results --port 9999
.PHONY: allure
